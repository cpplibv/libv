...
#define VM3_PROPERTY_VISITOR_TYPE_HELPER(TYPE, ID) \
		void visit(const std::string& id, const TYPE& value) override { \
			...
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec2i, 0x0010)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec3i, 0x0011)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec4i, 0x0012)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec2f, 0x0020)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec3f, 0x0021)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec4f, 0x0022)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec2d, 0x0030)
			VM3_PROPERTY_VISITOR_TYPE_HELPER(vec3d, 0x0031)
...
#define VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(TYPE, ID) case ID: { TYPE value; ar & LIBV_NVP(value); \
				...
				default:
					...
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec2i, 0x0010)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec3i, 0x0011)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec4i, 0x0012)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec2f, 0x0020)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec3f, 0x0021)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec4f, 0x0022)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec2d, 0x0030)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec3d, 0x0031)
					VM3_PROPERTY_DESERIALIZE_TYPE_HELPER(vec4d, 0x0032)
