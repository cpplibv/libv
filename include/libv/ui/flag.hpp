...
//static constexpr Flag_t parentsDependOnLayout = libv::bit(21); /// Component layout change will affect parent's layout (layout invalidation on dynamic content size change is only required if this flag is set)
