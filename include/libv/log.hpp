...
#define VLOG_TRACE(LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_TRACE, libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
#define VLOG_DEBUG(LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_DEBUG, libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
#define VLOG_INFO( LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_INFO , libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
#define VLOG_NOTIF(LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_NOTIF, libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
#define VLOG_WARN( LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_WARN , libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
#define VLOG_ERROR(LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_ERROR, libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
#define VLOG_FATAL(LOG, FORMAT, ARGS...) (LOG).log(VLOG_SEVERITY_FATAL, libv::format((FORMAT), ##ARGS), __VFILENAME__, __FUNCTION__, __LINE__);
