...
model.scale(0.175 * 100.0)
--model.scale(0.175 * 25.0)
...
--model.regex_replace_textures("Tree_med.fixed.game.fbm/DB2X2_L01.png", "../../res/model/tree_01_test_leaves.diffuse.png");
model.regex_replace_textures("Tree_med.fixed.game.fbm/DB2X2_L01.png", "../../res/model/tree_01_leaves_2.diffuse.png");
