...
//	libv::exponential_moving_average<double, 10.0, 0.9> avg01{0};
//	libv::exponential_moving_average<double, 10.0, 0.9> avg02{0};
//	libv::exponential_moving_average<double, 10.0, 0.9> avg05{0};
//	libv::exponential_moving_average<double, 10.0, 0.9> avg10{0};
//	libv::exponential_moving_average<double, 10.0, 0.9> avg20{0};
//	libv::exponential_moving_average<double, 10.0, 0.9> avg50{0};
	...
	CHECK(avg01.value() == libv::approx(0.9));
	CHECK(avg02.value() == libv::approx(0.9));
	CHECK(avg05.value() == libv::approx(0.9));
	CHECK(avg10.value() == libv::approx(0.9));
	CHECK(avg20.value() == libv::approx(0.9));
	CHECK(avg50.value() == libv::approx(0.9));
	...
	CHECK(avg01.value() == libv::approx(0.99));
	CHECK(avg02.value() == libv::approx(0.99));
	CHECK(avg05.value() == libv::approx(0.99));
	CHECK(avg10.value() == libv::approx(0.99));
	CHECK(avg20.value() == libv::approx(0.99));
	CHECK(avg50.value() == libv::approx(0.99));
