...
////"typename..." inserted
////
////Signal<typename RType,typename...Args>
//////  ^  ^        ^     ^       ^  ^
//////  1  2        3     4       5  6
////
////Code completion in (1) position 
////------------------------------------------------------------------------------
////Code completion on "using" syntax with functions insert unnecessary "()" parentheses
////
////using Scope::function();
//////           ^       ^ 
//////           1       2
////
////Code completion in (1) position puts parentheses to (2) position. This behaviour 
////is desired in other cases, but this one.
////------------------------------------------------------------------------------
////Code completion suggesting (the small icon on the left side of the pop-up pane)
////the wrong visibility if visibility changed during inheritance by the use of
////"using" syntax
////
////using Base::function;
////
...
//////     1
////
////Code completion in (1) position suggesting the visibility is protected.
////------------------------------------------------------------------------------
////Unused variable
////
...
////
////------------------------------------------------------------------------------
////Code completion suggesting only the first overload of functions by "using"
////member function syntax in classes
////
//// screenshot here
////