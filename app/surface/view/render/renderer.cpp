// Project: libv, File: app/surface/view/render/renderer.cpp
...
void RendererDebug::add_debug_frustum(std::array<libv::vec3f, 8> corners, libv::vec4f color_wire, libv::vec4f color_sides) {
	frustums.push_back(RendererDebug::Frustum{corners, color_sides, color_wire});
	dirty = true;
}
