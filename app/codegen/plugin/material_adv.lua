...
shader.generate = function(rules)
	...
	local material_class_name = "MaterialAdv" .. rules.name;

	local fn_hpp = function(out)
		out("\n")

		out("class " .. material_class_name .. " : public libv::rev::BaseMaterialAdv {\n")
		out("public:\n")
		out("\tusing ptr = libv::intrusive2_ptr<" .. material_class_name .. ">;\n")

		-- -------------------------------------------------------------------------------------------------

		out("\n")
		out("public:\n")
		out("\t[[nodiscard]] static ptr create(const MaterialScanner& scan);\n")
		out("\t[[nodiscard]] static ptr create(libv::rev::ResourceManager& rm);\n")
		...
		--end
		--
		--out("\tvirtual void register_uniforms(ContextRender& ctx) override;\n")
		--out("\tvirtual void activate_uniforms(ContextRender& ctx) override;\n")
...
--	"// virtual bool utilizes(ModelVertexAttribute attribute) override;"
	...
	local fn_cpp = function(out)
		--out("\n")
		--out(material_class_name .. "::ptr " .. material_class_name .. "create(const MaterialScanner& scan) {\n")
		--out("}\n")
		--out("\n")
		--out(material_class_name .. "::ptr " .. material_class_name .. "create(libv::rev::ResourceManager& rm) {\n")
		--out("}\n")
		...
		--out("\n")
		--out("void " .. material_class_name .. "::register_uniforms(ContextRender& ctx) {\n")
		--out("}\n")
		--out("\n")
		--out("void " .. material_class_name .. "::activate_uniforms(ContextRender& ctx) {\n")
		--out("}\n")
	end

	include_hpp("libv/rev/fwd.hpp")
	include_hpp("libv/rev/material_adv/material_adv.hpp")
