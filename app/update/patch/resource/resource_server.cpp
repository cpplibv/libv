// Project: libv, File: app/update/patch/resource/resource_server.cpp, Author: Császár Mátyás [Vader]

// hpp
#include <update/patch/resource/resource_server.hpp>
// libv
...
#include <mutex>
// pro
#include <update/patch/resource/codec.hpp>
#include <update/patch/resource/resource_common.lpp>
...
#include <update/patch/resource/read_file_stop.hpp>
...
//class ConnectionAsyncIH : libv::net::mtcp::ConnectionAsyncCB {
//public:
//	using ErrorSource = libv::net::mtcp::ConnectionAsyncCB::ErrorSource;
//
//public:
//	ConnectionAsyncIH() {
//		const auto connect_cb = [this](libv::net::mtcp::Endpoint local_endpoint, libv::net::mtcp::Endpoint remote_endpoint) {
//			on_connect(local_endpoint, remote_endpoint);
//		};
//
...
//		};
//
//		const auto error_cb = [this](ErrorSource source, std::error_code ec) noexcept {
//			on_error(source, ec);
//		};
//
//		const auto receive_cb = [this](libv::net::mtcp::Message&& message) noexcept {
//			on_recive(std::move(message));
//		};
//
//		const auto send_cb = [this](libv::net::mtcp::Message&& message) noexcept {
//			on_send(std::move(message));
//		};
//
//		handle_connect(connect_cb);
//		handle_disconnect(disconnect_cb);
//		handle_error(error_cb);
//		handle_receive(receive_cb);
//		handle_send(send_cb);
//	}
//
//private:
//	virtual void on_connect(libv::net::mtcp::Endpoint local, libv::net::mtcp::Endpoint remote) = 0;
//	virtual void on_disconnect() = 0;
//	virtual void on_error(ErrorSource source, std::error_code ec) = 0;
//	virtual void on_recive(libv::net::mtcp::Message&& message) = 0;
//	virtual void on_send(libv::net::mtcp::Message&& message) = 0;
//};
...
struct BaseServer {
	std::vector<libv::net::mtcp::ConnectionAsyncCB> connections;
};
