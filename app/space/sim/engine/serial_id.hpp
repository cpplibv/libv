// Project: libv, File: app/space/sim/engine/serial_id.hpp
...
/// During deserialization an SnapshotPtrResolverArchive output archive (yes, output and not input, due to input would modify everything)
/// can be used to reverse look up IDs to pointers
///
/// \Usage
