...
public:
	...
	constexpr inline void setNormalAndPoint(libv::vec3f normal, libv::vec3f point = {0, 0, 0}) noexcept {
		this->normal = normal;
	...
	constexpr inline void set3Points(libv::vec3f p1, libv::vec3f p2, libv::vec3f p3) noexcept {
