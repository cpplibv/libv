...
void pushMMat(const glm::mat4& m) {
...
void pushVMat(const glm::mat4& m) {
	VMatStack.push(VMatStack.top() * m);
}
...
void pushPMat(const glm::mat4& m) {
	PMatStack.push(PMatStack.top() * m);
}
