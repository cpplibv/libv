...
// hpp
#include <libv/control/input_id.hpp>
// libv
...
std::ostream& InputID::to_stream_identifier(std::ostream& os) const{
	return libv::control::to_stream_identifier(os, *this);
}
...
std::ostream& InputID::to_stream_description(std::ostream& os) const{
	return libv::control::to_stream_description(os, *this);
}
...
std::string InputID::to_string_identifier() const {
	return libv::control::to_string_identifier(*this);
}
...
std::string InputID::to_string_description() const {
	return libv::control::to_string_description(*this);
}
