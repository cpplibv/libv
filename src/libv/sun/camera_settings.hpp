// Project: libv.sun, File: src/libv/sun/camera_settings.hpp
...
//
//	libv::ctrl::scale_group control_speed_rotate{
...
//	};
//
//	libv::ctrl::scale_group control_speed_translate{
//			.impulse = 0.1,
//			.time = 1.0,
//			.mouse = 1.0 / 600.0,
//			.scroll = 0.1,
...
//	};
//
//	libv::ctrl::scale_group control_speed_orbit{
//			.impulse = 0.5,
//			.time = 4.0,
//			.mouse = 4.0 / 600.0,
//			.scroll = 0.20,
