// Project: libv.ecs, File: src/libv/ecs/entity.hpp, Author: Császár Mátyás [Vader]
...
struct ChildOfCmp {
	inline bool operator()(const Entity& lhs, const EntityID& rhs) const noexcept {
		return (lhs.id >> 32) < rhs;
	}
	inline bool operator()(const EntityID& lhs, const Entity& rhs) const noexcept {
