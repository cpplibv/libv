// Project: libv.utility, File: src/libv/utility/tuple.hpp
...
template <typename F, template <typename...> class Tuple, typename... Args, std::size_t... Is>
...
template <template <typename...> class Tuple, typename... Args, std::size_t... Is>
