// Project: libv.update, File: src/libv/update/resource/resource_client.cpp, Author: Császár Mátyás [Vader]

// hpp
#include <libv/update/resource/resource_client.hpp>
//// libv
...
////using ev_UpdateInfo = libv::state::ev<msg::UpdateRoute>;
