...
enum class AlignHorizontal : int8_t {
	right = 0,
	center = 1,
	left = 2,
	justify = 3,
...
[[nodiscard]] constexpr inline int8_t underlying(AlignHorizontal enum_value) noexcept {
	return static_cast<int8_t>(enum_value);
}
[[nodiscard]] constexpr inline int8_t operator+(AlignHorizontal enum_value) noexcept {
	return static_cast<int8_t>(enum_value);
}
