...
public:
	...
	void margin_extent(MarginExtent value) noexcept;
	[[nodiscard]] MarginExtent margin_extent() const noexcept;
	...
	void padding_extent(PaddingExtent value) noexcept;
	[[nodiscard]] PaddingExtent padding_extent() const noexcept;
