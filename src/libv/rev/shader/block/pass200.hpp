...
struct UniformLayoutPass200 {
	...
	libv::glr::Uniform_vec4f frame_random_float;
	libv::glr::Uniform_vec4i frame_random_int;
	...
	LIBV_REFLECTION_ACCESS(frame_random_float);
	LIBV_REFLECTION_ACCESS(frame_random_int);
};
