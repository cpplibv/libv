...
save_result save(save_format f, const libv::vec3f* data, size_t size_x, size_t size_y, int quality = 80);
save_result save(save_format f, const libv::vec4f* data, size_t size_x, size_t size_y, int quality = 80);
save_result save(save_format f, const libv::vec3uc* data, size_t size_x, size_t size_y, int quality = 80);
save_result save(save_format f, const libv::vec4uc* data, size_t size_x, size_t size_y, int quality = 80);
...
save_result save_dds(const libv::vec3f* data, size_t size_x, size_t size_y); /// DXT1
save_result save_dds(const libv::vec4f* data, size_t size_x, size_t size_y); /// DXT5
save_result save_dds(const libv::vec3uc* data, size_t size_x, size_t size_y); /// DXT1
save_result save_dds(const libv::vec4uc* data, size_t size_x, size_t size_y); /// DXT5

save_result save_jpg(const libv::vec3f* data, size_t size_x, size_t size_y, int quality = 80);
save_result save_jpg(const libv::vec4f* data, size_t size_x, size_t size_y, int quality = 80);
save_result save_jpg(const libv::vec3uc* data, size_t size_x, size_t size_y, int quality = 80);
save_result save_jpg(const libv::vec4uc* data, size_t size_x, size_t size_y, int quality = 80);
